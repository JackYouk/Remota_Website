                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-7 mt-50 pb-120"><span className="tag-1 bg-green-900">IT Asset Management</span>
                                    <h1 className="text-display-2 mt-20">Fast. Flexible. Discrete.</h1>
                                ...
                                <div className="col-lg-5 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        <div className="block-1 shape-3"><img src="https://imgs.search.brave.com/pOkPrCNZxfhQ47j_rtNtiQoiQmEoxCYafHs-qoGcZZE/rs:fit:1200:1080:1/g:ce/aHR0cHM6Ly9jZG4u/c2hvcGlmeS5jb20v/cy9maWxlcy8xLzAz/OTIvNTA0NS9wcm9k/dWN0cy9BcHBsZV9N/YWNCb29rX1Byb18x/My1pbmNoX0Nhc2Vf/QmxhY2tfMDAwNi5w/bmc_dj0xNjAwOTQw/Mzk0" alt="Macbook Pro Laptop" /></div>
                                        <div className="block-2 shape-3"><img src="https://imgs.search.brave.com/5T64YxuwxR60IspaeBZLj3KF2jQlVoEhJLWvHFezxYU/rs:fit:400:132:1/g:ce/aHR0cHM6Ly9pbWFn/ZXMubWFjcnVtb3Jz/LmNvbS90L1piWE5x/OGJwOXVwV1p4eG1Q/d25oMzNfeXBYWT0v/NDAweDAvZmlsdGVy/czpxdWFsaXR5KDkw/KS9hcnRpY2xlLW5l/dy8yMDEzLzA5L21h/Y2Jvb2tfYWlyX3Ry/aW9fdHJhbnNwYXJl/bnQucG5nP2xvc3N5" alt="Laptop Mailer" /></div>
                                        {/* <img className="img-banner img-responsive shape-2" alt="Man with phone" src="assets/imgs/page/homepage6/banner.png" /> */}
                                    </div>
                                </div>
                            </div>
                        </div>
